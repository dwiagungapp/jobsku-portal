        ...
        <>
            <nav className="bg-blue-900 text-white sticky top-0">
                <div className="container mx-auto px-4 py-3 md:flex md:justify-between md:items-center ">
                    ...
                    >
                        <span
                            className="block mt-4 md:inline-block md:mt-0 md:ml-6 text-blue-300 hover:text-white cursor-pointer"
                        ...
                        <span
                            className="block mt-4 md:inline-block md:mt-0 md:ml-6 text-blue-300 hover:text-white cursor-pointer"
                            onClick={() => window.location.href = "#lowongankerja"}
                        >
                            Lowongan
                        </span>

                        {isLoggedIn ? (
                            <span className="block mt-4 md:inline-block md:mt-0 md:ml-6">
